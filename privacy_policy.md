...
---
#### Coolie Table
|  Name | Site | From | Type | Privacy Policy | Description |
|  ------ | ------ | :------ | ------ | ------ | ------ |
|  PHPSESSID | kwiksher.com | WP-SpamShield Anti-Spam | Necessary | https://www.redsandmarketing.com/plugins/wp-spamshield-anti-spam/gdpr/ | session cookie and technique created by the WP-SpamShield Anti-Spam plugin that allows WordPress to filter bots of legitimate users when sending a form from the web, thus preventing the creation of content and the sending of spam-type emails. |
|  SJECT16 | kwiksher.com | WP-SpamShield Anti-Spam | Necessary | https://www.redsandmarketing.com/plugins/wp-spamshield-anti-spam/gdpr/ | session cookie and technique created by the WP-SpamShield Anti-Spam plugin that allows WordPress to filter bots of legitimate users when sending a form from the web, thus preventing the creation of content and the sending of spam-type emails. |
|  JCS_INENREF | kwiksher.com | WP-SpamShield Anti-Spam | Necessary | https://www.redsandmarketing.com/plugins/wp-spamshield-anti-spam/gdpr/ | session cookie and technique created by the WP-SpamShield Anti-Spam plugin that allows WordPress to filter bots of legitimate users when sending a form from the web, thus preventing the creation of content and the sending of spam-type emails. |
|  JCS_INENTIM | kwiksher.com | WP-SpamShield Anti-Spam | Necessary | https://www.redsandmarketing.com/plugins/wp-spamshield-anti-spam/gdpr/ | session cookie and technique created by the WP-SpamShield Anti-Spam plugin that allows WordPress to filter bots of legitimate users when sending a form from the web, thus preventing the creation of content and the sending of spam-type emails. |
|  __ar_v4 | kwiksher.com | Adroll | Advertising | https://www.adrollgroup.com/privacy | DITA uses DoubleClick to place advertisements that point to our website in Google search results. This cookie is used to track conversion rates for these ads. |
|  __utma | kwiksher.com | Google Analytics | Performance | https://policies.google.com/privacy?hl=en | Used by Google for user behaviour tracking |
|  __utmb | kwiksher.com | Google Analytics | Performance | https://policies.google.com/privacy?hl=en | Used by Google for user behaviour tracking |
|  __utmc | kwiksher.com | Google Analytics | Performance | https://policies.google.com/privacy?hl=en | Used by Google for user behaviour tracking |
|  __utmz | kwiksher.com | Google Analytics | Performance | https://policies.google.com/privacy?hl=en | Used by Google for user behaviour tracking |
|  _ga | kwiksher.com | Google Analytics | Performance | https://policies.google.com/privacy?hl=en | Used by Google for user behaviour tracking |
|  _gid | kwiksher.com | Google Analytics | Performance | https://policies.google.com/privacy?hl=en | Used by Google for user behaviour tracking |
|  _gat | kwiksher.com | Google Analytics | Performance | https://policies.google.com/privacy?hl=en | Used by Google for user behaviour tracking |
|  gdpr[allowed_cookies] | kwiksher.com | Plugin | Necessary | https://gdpr-wp.com/privacy-policy/ | created by the GDPR WP plugin that allows WordPress to save users' consent to continue navigating the web, when it is established, the message of acceptance of cookies does not appear again. |
|  gdpr[consent_types] | kwiksher.com | Plugin | Necessary | https://gdpr-wp.com/privacy-policy/ | created by the GDPR WP plugin that allows WordPress to save users' consent to continue navigating the web, when it is established, the message of acceptance of cookies does not appear again. |
|  ~~viewed_cookie_policy~~ | ~~kwiksher.com~~ | ~~Plugin~~ | ~~Necessary~~ | ~~https://www.wpgdprc.com/privacy-policy/~~ | ~~persistent cookie and personalization created by the Cookie Law Info plugin that allows WordPress to save users' consent to continue navigating the web, when it is established, the message of acceptance of cookies does not appear again.~~ |
|  woocommerce_cart_hash | kwiksher.com | Plugin | Necessary | https://woocommerce.com/privacy-policy/ | Stores an encoded string representing the contents of the WooCommerce shopping cart. |
|  woocommerce_items_in_cart | kwiksher.com | Plugin | Necessary | https://woocommerce.com/privacy-policy/ | Records if there are any items in the WooCommerce shopping cart. |
|  woocommerce_recently_viewed | kwiksher.com | Plugin | Necessary | https://woocommerce.com/privacy-policy/ | Contains an array of up to 15 recently viewed products.No personal information is stored within these cookies |
|  wordpress_[serial_num] | kwiksher.com | Wordpress | Necessary | https://wordpress.org/about/privacy/ | WordPress uses these cookies to store your authentication details, and their use is limited to the admin console area. |
|  wordpress_logged_in_[serial_num] | kwiksher.com | Wordpress | Necessary | https://wordpress.org/about/privacy/ | WordPress uses this cookie to indicate when you’re logged in, and who you are, for most interface use. |
|  wordpress_sec_[serial_num] | kwiksher.com | Wordpress | Necessary | https://wordpress.org/about/privacy/ | These cookies are set by our site when you login to use the ViSIONS section of the site. |
|  wordpress_test_cookie | kwiksher.com | Wordpress | Necessary | https://wordpress.org/about/privacy/ | WordPress sets this cookie when you navigate to the login page. The cookie is used to check whether your web browser is set to allow, or reject cookies. |
|  wp-saving-post | kwiksher.com | Wordpress | Functionality | https://wordpress.org/about/privacy/ | WordPress cookie created when auto-saving a post in the editor. |
|  wp-settings-[serial_num] | kwiksher.com | Wordpress | Functionality | https://wordpress.org/about/privacy/ | This is used to customize your view of admin interface, and possibly also the main site interface. |
